...
(function (Popcorn) {
  ...
  Popcorn.plugin( "vieflickr" , {
	  ...
	  _setup : function( options ) {
		if (layerindex==1){	  
			importclass("lib/jquery-ui-1.8.16.js");
			importclass("lib/underscore.js");
			importclass("lib/backbone.js");
			importclass("lib/vie.js");
			importclass("lib/schema.json");
			importclass("lib/wrapper.js");
			importclass("lib/vie.widget.image_search.js");
			layerindex++;
		}
		...
		newContent = document.createTextNode(options.text);
		this.viesupp2.appendChild(newContent);
		this.viesupp.appendChild(this.viesupp2);
		document.getElementById("flickr").appendChild(this.viesupp);
